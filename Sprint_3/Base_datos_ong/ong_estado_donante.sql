...
CREATE TABLE `estado_donante` (
  `Id_estado` varchar(512) NOT NULL,
  `Estado_donante` varchar(512) DEFAULT NULL,
...
INSERT INTO `estado_donante` VALUES ('1','ACTIVO'),('2','INACTIVO');
...
-- Dump completed on 2024-10-24 20:16:17
