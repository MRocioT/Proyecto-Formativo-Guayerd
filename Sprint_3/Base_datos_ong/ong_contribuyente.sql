...
CREATE TABLE `contribuyente` (
  `Id_contribuyente` varchar(512) NOT NULL,
  `Tipo_contribuyente` varchar(512) DEFAULT NULL,
...
INSERT INTO `contribuyente` VALUES ('1','Monotributista'),('2','Exento'),('3','Responsable Inscripto');
